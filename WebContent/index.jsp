                ...
                <section class="scrollable padder-lg w-f-md" id="bjax-target">
                  ...
                  <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="${pageContext.request.contextPath }${newSong.imgurl }" alt="" class="r r-2x img-full" style="height:200px"></a>
                            </div>
                            <div class="padder-v">
                              <a href="#" class="text-ellipsis">${newSong.name }</a>
                              <a href="#" class="text-ellipsis text-xs text-muted">${newSong.artist }</a>
                            </div>
                          </div>
                        </div>
                        </c:forEach>
                    ...
                    <div class="col-md-5">
                      ...
                      <c:forEach items="${newSongList }" var="newSong" varStatus="s">                          
                        <a href="#" class="list-group-item clearfix">
                          <span class="pull-right h2 text-muted m-l">${s.index+1}</span>
                          <span class="pull-left thumb-sm avatar m-r">
                            <img src="${pageContext.request.contextPath }${newSong.imgurl }" alt="..." style="height:35px">
                          </span>
                          <span class="clear">

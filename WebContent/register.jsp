...
<head>
	...
	<link href="static/css/popup-box.css" rel="stylesheet" type="text/css" media="all" /> <!-- popup box css -->
...
<section class="register">
	...
	<!-- copyright -->
	<p class="agile-copyright">Copyright &copy; 2019.Company name All rights reserved. BoomBoomBoom</p>
	<!-- //copyright -->
</section>
<!-- //section -->
	...
	<div id="small-dialog2" class="mfp-hide book-form">
		...
		<div class="login-form login-form-left">
			<div class="agile-row">
				<h3>Register form</h3>
				<div class="login-agileits-top">
					<form action="${pageContext.request.contextPath}/RegisterServlet" method="post" id="regForm">
						<input type="text" class="username" name="username" Placeholder="Full Name" required=""/>
						<input type="email" class="email" name="email" Placeholder="Email" required="" id="email"/>
						<input type="text" class="mobilenumber" name="mobilenumber" Placeholder="Phone Number" required=""/>
						<input type="password" class="password" name="password" Placeholder="Password" required=""/>
